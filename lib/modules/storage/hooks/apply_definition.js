...
import { getModifierAsync as protoGetModifierAsync } from '../utils/getModifier_async';
...
function onApplyDefinition(Class, parsedDefinition) {
  ...
  if (parsedDefinition.collection) {
    ...
    Class.prototype.getModifier = protoGetModifierAsync;
    Class.prototype.getModified = protoGetModifiedAsync;
    Class.prototype.getModifiedValues = protoGetModifiedValuesAsync;
    Class.prototype.isModified = protoIsModifiedAsync;
  }
