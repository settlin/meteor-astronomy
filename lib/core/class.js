...
class Class {
  constructor(rawDoc = {}, options = {}) {
    ...
    if (Class.getCollection()) {
      doc._isNew = _has(rawDoc, "_isNew") ? rawDoc._isNew : true;
		...
		// can not use await here as it is inside a constructor
  ...
  static isParentOf(Class) {
    ...
    return Object.prototype.isPrototypeOf.call(this.prototype, Class.prototype);
  }
  ...
  static isChildOf(Class) {
    ...
    return Object.prototype.isPrototypeOf.call(Class.prototype, this.prototype);
  }
